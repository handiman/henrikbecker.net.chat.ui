...
const CvChat = class {
    ...
    render() {
        return (index.h("div", { key: 'e40d048fd505ae78bd8c5c087a1663f8a292aedc', part: "container" }, index.h("div", { key: '40d7643f66a4c771f4060103c8aea5a85257ce27', class: "chat-header" }, index.h("button", { key: 'b7a79c78e52f46c74a1d019af333479d773057f7', class: "minimize", onClick: () => this.toggleMinimize() }, this.minimized ? '▲' : '▼')), !this.minimized && this.answerPosition == 'above' && this.answer && (index.h("div", { key: 'c999edd159e8323a0c7d8a8b8e74eb3eaf83ad0a', part: "response" }, index.h("p", { key: '846ffb4a73321505bb0ceadfe99ebd8188daa810' }, this.answer), index.h("span", { key: '7c8427a5f85a2065659f7295b12b5a654104698a', part: "confidence", class: `confidence ${this.confidence.toLowerCase()}` }, this.confidence))), index.h("div", { key: 'd7e1da0dc02ca98f25a501a91372a04d2a78525a', class: "input-wrapper" }, index.h("input", { key: '098b43aac4df52260baf7842fae2b12dbd77cf1f', id: "question", part: "input", type: "text", value: this.question, onInput: e => this.question = e.target.value, onKeyDown: e => this.handleKeyDown(e), placeholder: this.placeholder }), index.h("button", { key: 'ac65744841459a3abc857d075d82256d8c1230b3', part: "icon-button", class: "ask-button", onClick: () => this.handleAsk(), disabled: this.loading, title: "Ask" }, this.loading ? (index.h("img", { src: "/favicon.ico", class: "spinner" })) : (index.h("img", { src: "/favicon.ico" })))), !this.minimized && this.answerPosition == 'below' && this.answer && (index.h("div", { key: '01eaf3eb4f22534dc10113dfc0613d78fecd9fcc', part: "response" }, index.h("p", { key: '4601c662bccc9e0f4ccee0e09bc59cafeb0c58ef' }, this.answer), index.h("span", { key: '1f2c61dd227f83c108a389d0349e6ec9ebe4ba9c', part: "confidence", class: `confidence ${this.confidence.toLowerCase()}` }, this.confidence)))));
    }
};
