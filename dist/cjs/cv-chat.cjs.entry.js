...
const CvChat = class {
    ...
    render() {
        return (index.h("div", { key: '98ceca848f4fe7a2fab785b2a03a620d47f60aec', part: "container" }, !this.minimized && this.answerPosition == 'above' && this.answer && (index.h("div", { key: 'fd5acb037572f8c987ea5a96e6a862ca99e7b6cd', part: "response" }, index.h("p", { key: '59b123542d25b0b4f29e6fe5fbc3827172a4c567' }, this.answer), index.h("span", { key: '1c6932b54821ca0269a98fad41aa37cfc9902380', part: "confidence", class: `confidence ${this.confidence.toLowerCase()}` }, this.confidence))), index.h("div", { key: '2e104ab4946390f7b275bba9376bb5dce15c5dd4', class: "input-wrapper" }, index.h("input", { key: 'e281a23a8f9f7b98152fbfbefeedd33efc92f56c', id: "question", part: "input", type: "text", value: this.question, onInput: e => this.question = e.target.value, onKeyDown: e => this.handleKeyDown(e), placeholder: this.placeholder }), index.h("button", { key: 'e2e356d09f22a6960c1c540b3666414b25f0f4cd', part: "icon-button", class: "ask-button", onClick: () => this.handleAsk(), disabled: this.loading, title: "Ask" }, this.loading ? (index.h("img", { src: "/favicon.ico", class: "spinner" })) : (index.h("img", { src: "/favicon.ico" })))), !this.minimized && this.answerPosition == 'below' && this.answer && (index.h("div", { key: 'a6749dc638b2025e7e1a37b67bb663b3c03b2cfb', part: "response" }, index.h("p", { key: '76af986c70b76af7343e36efb81171ee20e9387b' }, this.answer), index.h("span", { key: '03a7bd67655bbd40613baa166d23847a29be92cd', part: "confidence", class: `confidence ${this.confidence.toLowerCase()}` }, this.confidence)))));
    }
};
