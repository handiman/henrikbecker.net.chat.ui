...
const CvChat = class {
    ...
    render() {
        return (index.h("div", { key: 'e616e4da5d4dc5ddf3d49f461a88ed08e831e069', part: "container" }, index.h("div", { key: 'c9edcda4234c3b0bbaf82809ea485e2571426a7e', class: "input-wrapper" }, index.h("input", { key: '016af5db79a3a2ae95edc25abd816b48a1db25f4', id: "question", part: "input", type: "text", value: this.question, onInput: e => this.question = e.target.value, onKeyDown: e => this.handleKeyDown(e), placeholder: this.placeholder }), index.h("button", { key: '870bd903e7573c54d3c2676256a7bfbe3bbde173', part: "icon-button", class: "ask-button", onClick: () => this.handleAsk(), disabled: this.loading, title: "Ask" }, this.loading ? (index.h("img", { src: "/favicon.ico", class: "spinner" })) : (index.h("img", { src: "/favicon.ico" })))), this.answer && (index.h("div", { key: 'bd7af4f888dbfad337e58a790b359aa90239ce79', part: "response" }, index.h("p", { key: '486c754bd43099a753a3a339725f5019c5e6265a' }, this.answer), index.h("span", { key: '87a5db38f2179eb7ed01b8f3e2f4a5f5f60c72f6', part: "confidence", class: `confidence ${this.confidence.toLowerCase()}` }, this.confidence)))));
    }
};
