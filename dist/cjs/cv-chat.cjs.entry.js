...
const CvChat = class {
    ...
    render() {
        return (index.h("div", { key: '750267cf852ef6a4efe238ff8141e85f5a1fa2b8', part: "container" }, index.h("div", { key: '8e45f10f829499dbea9e7e8fc1560eb024d7aab1', class: "input-wrapper" }, index.h("input", { key: 'e757ba7225f83e8004bd27e7fa92ceff9e25aa4b', id: "question", part: "input", type: "text", value: this.question, onInput: e => this.question = e.target.value, onKeyDown: e => this.handleKeyDown(e), placeholder: this.placeholder }), index.h("button", { key: '54f62175aebe6aea4060a0e48f79e9f3ae1cfc52', part: "icon-button", class: "ask-button", onClick: () => this.handleAsk(), disabled: this.loading, title: "Ask" }, this.loading ? (index.h("img", { src: "/favicon.ico", class: "spinner" })) : (index.h("img", { src: "/favicon.ico" })))), !this.minimized && this.answer && (index.h("div", { key: '1768982e981a059ec20cfd0ac0cd3d3d967945b9', part: "response" }, index.h("p", { key: '6586be440f1be115a405d656f7e606e67ee33b7d' }, this.answer), index.h("span", { key: '3ed541eb7f546610f91158755d2d85785d3595e6', part: "confidence", class: `confidence ${this.confidence.toLowerCase()}` }, this.confidence)))));
    }
};
