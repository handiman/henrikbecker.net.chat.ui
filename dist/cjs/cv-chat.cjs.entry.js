...
const CvChat = class {
    ...
    render() {
        return (index.h("div", { key: '38b7f1330f7a890ea9aa0ffed3a9984c1a9031c4', part: "container" }, index.h("div", { key: 'ad906c71cd08c4e6c3ae12ecf0e6a2cecda6503d', class: "input-wrapper" }, index.h("input", { key: '9a22295c26979aebccf1f6615ca544093b2db7fe', id: "question", part: "input", type: "text", value: this.question, onInput: e => this.question = e.target.value, onKeyDown: e => this.handleKeyDown(e), placeholder: this.placeholder }), index.h("button", { key: '054735de49c11b1e1eb364aa0e4a2f50ac7113a6', part: "icon-button", class: "ask-button", onClick: () => this.handleAsk(), disabled: this.loading, title: "Ask" }, this.loading ? (index.h("img", { src: "/favicon.ico", class: "spinner" })) : (index.h("img", { src: "/favicon.ico" })))), !this.minimized && this.answer && (index.h("div", { key: '7b74014c633b36065e7dbcf5effb57f57e9ba972', part: "response", class: "response-box" }, index.h("p", { key: 'e2800d98fb99533f12d9455cc6e60f07681dbfd2' }, this.answer), index.h("span", { key: '64c036f7d388d4afed5cbbc47fd92bf8350f3e24', part: "confidence", class: `confidence ${this.confidence.toLowerCase()}` }, this.confidence), index.h("button", { key: 'b769b635a2876fe62ea9dae5047ad23313ce5dd0', class: "close-button", onClick: () => this.minimized = true, title: "St\u00E4ng" }, "\u00D7")))));
    }
