...
const CvChat = class {
    ...
    render() {
        return (index.h("div", { key: '2620ca422b38a5a3cb9a7ca368e0836c8b34b57c', part: "container" }, index.h("div", { key: 'deaa2247b35066de8cf78f1c10492415ebd9d6d6', class: "input-wrapper" }, index.h("input", { key: 'ce6249f9fe07a85d57a4747839a8b16d4b8d0a08', id: "question", part: "input", type: "text", value: this.question, onInput: e => this.question = e.target.value, onKeyDown: e => this.handleKeyDown(e), placeholder: this.questionPlaceholder }), index.h("button", { key: '39bcf980f700109606e4dd84dfee5baafaf995e9', part: "icon-button", class: "ask-button", onClick: () => this.handleAsk(), disabled: this.loading, title: "Ask" }, this.loading ? index.h("span", { class: "spinner" }) : '🤖')), this.answer && (index.h("div", { key: '7cd49eecd0200ccf07f74c53ad46bdefc37ee905', part: "response" }, index.h("p", { key: 'd271e82fd3f6e42d078b178716bc27f3030ecc6d' }, this.answer), index.h("span", { key: '4ca30db4960c57bd8efad02f84e68394f7de0063', part: "confidence", class: `confidence ${this.confidence.toLowerCase()}` }, this.confidence)))));
    }
};
