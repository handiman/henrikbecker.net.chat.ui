...
const CvChat = class {
    ...
    render() {
        return (index.h("div", { key: 'eb7c7ce3091802fe9faaf09bc605d07f577faf52', part: "container" }, index.h("div", { key: '8de2858af7239e685e59e71ed4ed3e1f20568738', class: "input-wrapper" }, index.h("input", { key: 'f42256811f329b493f29da3a95179df2494313a8', id: "question", part: "input", type: "text", value: this.question, onInput: e => this.question = e.target.value, onKeyDown: e => this.handleKeyDown(e), placeholder: this.placeholder }), index.h("button", { key: '06d13c962fcbf6246bdd8e7f5ca805164be53192', part: "icon-button", class: "ask-button", onClick: () => this.handleAsk(), disabled: this.loading, title: "Ask" }, this.loading ? (index.h("img", { src: "/favicon.ico", class: "spinner" })) : (index.h("img", { src: "/favicon.ico" })))), !this.minimized && this.answer && (index.h("div", { key: 'b8a90a4e8c533ecb00596242df9c12a57a49d2d9', part: "response", class: "response-box" }, index.h("p", { key: '97e8a4dd82b1ee7f3721013f5eae50671ca9d6b1' }, this.answer), index.h("span", { key: '20a8de5a519745bacbfd4e0ba4411861c1bc3743', part: "confidence", class: `confidence ${this.confidence.toLowerCase()}` }, this.confidence), index.h("button", { key: '107ddd57a50e84c4ec0181f58b1abf5b4ff0499f', class: "close-button", onClick: () => this.minimized = true, title: "St\u00E4ng" }, "\u00D7")))));
    }
